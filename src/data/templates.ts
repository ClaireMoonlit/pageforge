...
export const pageTemplates: PageTemplate[] = [
  ...
  // ═══════════════════════════════════════════════
  {
    ...
    nodes: [
      ...
      // 3 张特性卡片（高度 160px，与内容实际高度（≈120-140）匹配，减小留白）
      { id: nid(), type: 'card', children: [], visible: true, props: { text: '拖拽编辑', subtitle: '直观的拖拽操作，无需代码即可自由布局。所见即所得，实时预览效果。', titleFontSize: '17px', titleColor: C.sDark, subtitleFontSize: '14px', subtitleColor: C.sGray }, style: { x: 80, y: 680, width: '320px', height: '160px', padding: '24px', backgroundColor: C.white, borderRadius: '12px', boxShadow: '0 1px 3px rgba(0,0,0,0.06)', display: 'flex', flexDirection: 'column', fontFamily: C.fInter } },
      { id: nid(), type: 'card', children: [], visible: true, props: { text: '一键导出', subtitle: '生成独立 HTML 文件，代码干净、结构清晰。部署到 Netlify、Vercel 或任意静态托管。', titleFontSize: '17px', titleColor: C.sDark, subtitleFontSize: '14px', subtitleColor: C.sGray }, style: { x: 440, y: 680, width: '320px', height: '160px', padding: '24px', backgroundColor: C.white, borderRadius: '12px', boxShadow: '0 1px 3px rgba(0,0,0,0.06)', display: 'flex', flexDirection: 'column', fontFamily: C.fInter } },
      { id: nid(), type: 'card', children: [], visible: true, props: { text: '响应式设计', subtitle: '桌面端绝对定位 + 移动端流式堆叠。一套设计，完美适配电脑、平板、手机。', titleFontSize: '17px', titleColor: C.sDark, subtitleFontSize: '14px', subtitleColor: C.sGray }, style: { x: 800, y: 680, width: '320px', height: '160px', padding: '24px', backgroundColor: C.white, borderRadius: '12px', boxShadow: '0 1px 3px rgba(0,0,0,0.06)', display: 'flex', flexDirection: 'column', fontFamily: C.fInter } },
      ...
      // 3 张定价卡片（高度 200px，与内容实际高度（≈130-145）匹配，减小留白；y=1020）
      { id: nid(), type: 'card', children: [], visible: true, props: { text: '免费版 · ¥0/月', subtitle: '✓ 3 个项目\n✓ 基础组件库\n✓ HTML 导出\n✓ 社区支持', titleFontSize: '18px', titleColor: C.sDark, subtitleFontSize: '14px', subtitleColor: C.sGray }, style: { x: 80, y: 1020, width: '320px', height: '200px', padding: '28px', backgroundColor: C.white, borderRadius: '12px', boxShadow: '0 1px 3px rgba(0,0,0,0.06)', border: '1px solid #e5e7eb', display: 'flex', flexDirection: 'column', fontFamily: C.fInter } },
      { id: nid(), type: 'card', children: [], visible: true, props: { text: '专业版 · ¥99/月', subtitle: '✓ 无限项目\n✓ 全部组件\n✓ 高级导出\n✓ 优先支持\n✓ 自定义域名', titleFontSize: '18px', titleColor: C.white, subtitleFontSize: '14px', subtitleColor: '#c7d2fe' }, style: { x: 440, y: 1020, width: '320px', height: '200px', padding: '28px', backgroundColor: C.sPrimary, borderRadius: '12px', boxShadow: '0 4px 16px rgba(79,70,229,0.3)', display: 'flex', flexDirection: 'column', fontFamily: C.fInter } },
      { id: nid(), type: 'card', children: [], visible: true, props: { text: '企业版 · 联系我们', subtitle: '✓ 专业版全部功能\n✓ 团队协作\n✓ API 接口\n✓ 专属支持\n✓ 定制开发', titleFontSize: '18px', titleColor: C.sDark, subtitleFontSize: '14px', subtitleColor: C.sGray }, style: { x: 800, y: 1020, width: '320px', height: '200px', padding: '28px', backgroundColor: C.white, borderRadius: '12px', boxShadow: '0 1px 3px rgba(0,0,0,0.06)', border: '1px solid #e5e7eb', display: 'flex', flexDirection: 'column', fontFamily: C.fInter } },

      // 底部 CTA 容器（定价卡片底部 1220，间距 60 → y=1280；高度 180 紧凑布局）
      {
        id: nid(), type: 'container', visible: true, props: {},
        style: { x: 80, y: 1280, width: '1040px', height: '180px', padding: '32px 40px', backgroundColor: '#312e81', borderRadius: '12px', position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' },
        children: [
          ...
          { id: nid(), type: 'text', children: [], visible: true, props: { text: '免费注册，10 分钟创建你的第一个页面。' }, style: { x: 280, y: 70, width: '480px', fontSize: '16px', color: '#c7d2fe', textAlign: 'center', lineHeight: '1.5', padding: '0', fontFamily: C.fInter } },
          // CTA 按钮：x=480 让 240 宽按钮居中在 1040 容器内（(1040-240)/2=400 是容器内偏移，加容器 x=80 = 480）
          { id: nid(), type: 'button', children: [], visible: true, props: { text: '立即免费开始' }, style: { x: 480, y: 115, width: '240px', fontSize: '16px', fontWeight: '600', color: C.sPrimary, backgroundColor: C.white, padding: '12px 32px', borderRadius: '10px', textAlign: 'center', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontFamily: C.fInter } },
        ],
      },
    ],
