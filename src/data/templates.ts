...
export const pageTemplates: PageTemplate[] = [
  ...
  // ═══════════════════════════════════════════════
  {
    ...
    nodes: [
      ...
      // 3 张定价卡片（高度 200，宽度 240，lineHeight 1.5，让 5 行 14px 文本更舒展）
      ...
      // x 位置 120/480/840：3 张卡片在画布内水平居中（左右各 120px 边距），
      // 卡片中心 240/600/960 与特性卡中心 240/600/960 完全对齐（特性卡宽 320，定价卡宽 240，所以 x 不同但中心一致）
      { id: nid(), type: 'card', children: [], visible: true, props: { text: '免费版 · ¥0/月', subtitle: '✓ 3 个项目\n✓ 基础组件库\n✓ HTML 导出\n✓ 社区支持', titleFontSize: '18px', titleColor: C.sDark, subtitleFontSize: '14px', subtitleColor: C.sGray, subtitleLineHeight: 1.5 }, style: { x: 120, y: 1020, width: '240px', height: '200px', padding: '24px', backgroundColor: C.white, borderRadius: '12px', boxShadow: '0 1px 3px rgba(0,0,0,0.06)', border: '1px solid #e5e7eb', display: 'flex', flexDirection: 'column', fontFamily: C.fInter } },
      ...
      { id: nid(), type: 'card', children: [], visible: true, props: { text: '企业版 · 联系我们', subtitle: '✓ 专业版全部功能\n✓ 团队协作\n✓ API 接口\n✓ 专属支持\n✓ 定制开发', titleFontSize: '18px', titleColor: C.sDark, subtitleFontSize: '14px', subtitleColor: C.sGray, subtitleLineHeight: 1.5 }, style: { x: 840, y: 1020, width: '240px', height: '200px', padding: '24px', backgroundColor: C.white, borderRadius: '12px', boxShadow: '0 1px 3px rgba(0,0,0,0.06)', border: '1px solid #e5e7eb', display: 'flex', flexDirection: 'column', fontFamily: C.fInter } },
