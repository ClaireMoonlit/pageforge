...
export const pageTemplates: PageTemplate[] = [
  ...
  // ═══════════════════════════════════════════════
  {
    ...
    nodes: [
      // 左侧深色栏
      {
        ...
        style: { x: 80, y: 60, width: '300px', minHeight: '780px', padding: '50px 35px', backgroundColor: C.rDark, borderRadius: '10px 0 0 10px', position: 'relative' },
        children: [
          { id: nid(), type: 'image', children: [], visible: true, props: { src: '', alt: '头像' }, style: { x: 55, y: 50, width: '120px', height: '120px', borderRadius: '60px', backgroundColor: C.rAccent } },
          { id: nid(), type: 'heading', children: [], visible: true, props: { text: '张三', level: 2 }, style: { x: 35, y: 195, width: '230px', fontSize: '26px', fontWeight: '700', color: C.white, textAlign: 'center', fontFamily: C.fInter } },
          { id: nid(), type: 'text', children: [], visible: true, props: { text: '高级前端工程师' }, style: { x: 35, y: 238, width: '230px', fontSize: '13px', color: '#a5b4fc', textAlign: 'center', lineHeight: '1.5', fontFamily: C.fInter } },
          { id: nid(), type: 'divider', children: [], visible: true, props: {}, style: { x: 35, y: 280, width: '230px', height: '1px', backgroundColor: '#334155', display: 'block' } },
          { id: nid(), type: 'heading', children: [], visible: true, props: { text: '联系方式', level: 3 }, style: { x: 35, y: 308, fontSize: '14px', fontWeight: '600', color: '#c7d2fe', textAlign: 'left', fontFamily: C.fInter } },
          { id: nid(), type: 'text', children: [], visible: true, props: { text: 'zhangsan@example.com\n138-0000-0000\n北京市朝阳区' }, style: { x: 35, y: 338, fontSize: '13px', color: '#94a3b8', textAlign: 'left', lineHeight: '2.2', fontFamily: C.fInter } },
          { id: nid(), type: 'divider', children: [], visible: true, props: {}, style: { x: 35, y: 450, width: '230px', height: '1px', backgroundColor: '#334155', display: 'block' } },
          { id: nid(), type: 'heading', children: [], visible: true, props: { text: '技术栈', level: 3 }, style: { x: 35, y: 478, fontSize: '14px', fontWeight: '600', color: '#c7d2fe', textAlign: 'left', fontFamily: C.fInter } },
          { id: nid(), type: 'text', children: [], visible: true, props: { text: 'React / Vue / TypeScript\nNode.js / Python\nTailwind CSS / Webpack\nDocker / AWS / CI/CD' }, style: { x: 35, y: 508, fontSize: '13px', color: '#94a3b8', textAlign: 'left', lineHeight: '2.2', fontFamily: C.fInter } },
        ],
      },
      // 右侧白色主内容
      {
        id: nid(), type: 'container', visible: true, props: {},
        style: { x: 380, y: 60, width: '820px', minHeight: '780px', padding: '50px 60px', backgroundColor: C.white, borderRadius: '0 10px 10px 0', position: 'relative' },
        children: [
          { id: nid(), type: 'heading', children: [], visible: true, props: { text: '关于我', level: 2 }, style: { x: 60, y: 50, fontSize: '22px', fontWeight: '700', color: C.rDark, textAlign: 'left', fontFamily: C.fInter } },
          { id: nid(), type: 'divider', children: [], visible: true, props: {}, style: { x: 60, y: 88, width: '50px', height: '3px', backgroundColor: C.rAccent, display: 'block' } },
          { id: nid(), type: 'text', children: [], visible: true, props: { text: '拥有 6 年前端开发经验，擅长 React 生态与性能优化。主导过多个大型项目从 0 到 1 的架构设计，注重代码质量与用户体验。' }, style: { x: 60, y: 108, width: '700px', fontSize: '15px', color: '#64748b', textAlign: 'left', lineHeight: '1.8', fontFamily: C.fInter } },
          { id: nid(), type: 'heading', children: [], visible: true, props: { text: '工作经历', level: 2 }, style: { x: 60, y: 205, fontSize: '22px', fontWeight: '700', color: C.rDark, textAlign: 'left', fontFamily: C.fInter } },
          { id: nid(), type: 'divider', children: [], visible: true, props: {}, style: { x: 60, y: 243, width: '50px', height: '3px', backgroundColor: C.rAccent, display: 'block' } },
          { id: nid(), type: 'card', children: [], visible: true, props: { text: '高级前端工程师 · ABC 科技', subtitle: '2022 - 至今 | 负责核心产品前端架构，主导 React 迁移至 Next.js，性能提升 40%。', titleFontSize: '16px', titleColor: C.rDark, subtitleFontSize: '14px', subtitleColor: '#64748b' }, style: { x: 60, y: 265, width: '640px', padding: '22px', backgroundColor: '#f8fafc', borderRadius: '10px', boxShadow: '0 1px 2px rgba(0,0,0,0.04)', fontFamily: C.fInter } },
          { id: nid(), type: 'card', children: [], visible: true, props: { text: '前端工程师 · XYZ 技术', subtitle: '2019 - 2022 | 参与电商平台前端开发，Vue 重构为微前端架构。', titleFontSize: '16px', titleColor: C.rDark, subtitleFontSize: '14px', subtitleColor: '#64748b' }, style: { x: 60, y: 390, width: '640px', padding: '22px', backgroundColor: '#f8fafc', borderRadius: '10px', boxShadow: '0 1px 2px rgba(0,0,0,0.04)', fontFamily: C.fInter } },
          { id: nid(), type: 'heading', children: [], visible: true, props: { text: '教育背景', level: 2 }, style: { x: 60, y: 520, fontSize: '22px', fontWeight: '700', color: C.rDark, textAlign: 'left', fontFamily: C.fInter } },
          { id: nid(), type: 'divider', children: [], visible: true, props: {}, style: { x: 60, y: 558, width: '50px', height: '3px', backgroundColor: C.rAccent, display: 'block' } },
          { id: nid(), type: 'card', children: [], visible: true, props: { text: '硕士 · 计算机科学 · 清华大学', subtitle: '2017 - 2019 | 研究方向：人机交互与前端性能优化', titleFontSize: '16px', titleColor: C.rDark, subtitleFontSize: '14px', subtitleColor: '#64748b' }, style: { x: 60, y: 580, width: '640px', padding: '22px', backgroundColor: '#f8fafc', borderRadius: '10px', boxShadow: '0 1px 2px rgba(0,0,0,0.04)', fontFamily: C.fInter } },
        ],
      },
    ],
  ...
  // ═══════════════════════════════════════════════
  {
    ...
    nodes: [
      ...
      { id: nid(), type: 'button', children: [], visible: true, props: { text: '开始免费使用 →' }, style: { x: 460, y: 270, fontSize: '16px', fontWeight: '600', color: C.white, backgroundColor: C.sPrimary, padding: '14px 36px', borderRadius: '10px', textAlign: 'center', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontFamily: C.fInter } },
      ...
      // 3 张特性卡片
      { id: nid(), type: 'card', children: [], visible: true, props: { text: '拖拽编辑', subtitle: '直观的拖拽操作，无需代码即可自由布局。所见即所得，实时预览效果。', titleFontSize: '17px', titleColor: C.sDark, subtitleFontSize: '14px', subtitleColor: C.sGray }, style: { x: 80, y: 670, width: '320px', padding: '28px', backgroundColor: C.white, borderRadius: '12px', boxShadow: '0 1px 3px rgba(0,0,0,0.06)', fontFamily: C.fInter } },
      { id: nid(), type: 'card', children: [], visible: true, props: { text: '一键导出', subtitle: '生成独立 HTML 文件，代码干净、结构清晰。部署到 Netlify、Vercel 或任意静态托管。', titleFontSize: '17px', titleColor: C.sDark, subtitleFontSize: '14px', subtitleColor: C.sGray }, style: { x: 440, y: 670, width: '320px', padding: '28px', backgroundColor: C.white, borderRadius: '12px', boxShadow: '0 1px 3px rgba(0,0,0,0.06)', fontFamily: C.fInter } },
      { id: nid(), type: 'card', children: [], visible: true, props: { text: '响应式设计', subtitle: '桌面端绝对定位 + 移动端流式堆叠。一套设计，完美适配电脑、平板、手机。', titleFontSize: '17px', titleColor: C.sDark, subtitleFontSize: '14px', subtitleColor: C.sGray }, style: { x: 800, y: 670, width: '320px', padding: '28px', backgroundColor: C.white, borderRadius: '12px', boxShadow: '0 1px 3px rgba(0,0,0,0.06)', fontFamily: C.fInter } },

      // 定价区标题
      { id: nid(), type: 'heading', children: [], visible: true, props: { text: '选择适合你的方案', level: 2 }, style: { x: 310, y: 810, width: '580px', fontSize: '30px', fontWeight: '700', color: C.sDark, textAlign: 'center', padding: '0', fontFamily: C.fSpace } },
      { id: nid(), type: 'text', children: [], visible: true, props: { text: '无论个人还是企业，都有合适的方案' }, style: { x: 360, y: 858, width: '480px', fontSize: '16px', color: C.sGray, textAlign: 'center', lineHeight: '1.5', padding: '0', fontFamily: C.fInter } },

      // 3 张定价卡片
      { id: nid(), type: 'card', children: [], visible: true, props: { text: '免费版 · ¥0/月', subtitle: '✓ 3 个项目\n✓ 基础组件库\n✓ HTML 导出\n✓ 社区支持', titleFontSize: '18px', titleColor: C.sDark, subtitleFontSize: '14px', subtitleColor: C.sGray }, style: { x: 80, y: 920, width: '320px', padding: '32px', backgroundColor: C.white, borderRadius: '12px', boxShadow: '0 1px 3px rgba(0,0,0,0.06)', border: '1px solid #e5e7eb', fontFamily: C.fInter } },
      { id: nid(), type: 'card', children: [], visible: true, props: { text: '专业版 · ¥99/月', subtitle: '✓ 无限项目\n✓ 全部组件\n✓ 高级导出\n✓ 优先支持\n✓ 自定义域名', titleFontSize: '18px', titleColor: C.white, subtitleFontSize: '14px', subtitleColor: '#c7d2fe' }, style: { x: 440, y: 920, width: '320px', padding: '32px', backgroundColor: C.sPrimary, borderRadius: '12px', boxShadow: '0 4px 16px rgba(79,70,229,0.3)', fontFamily: C.fInter } },
      { id: nid(), type: 'card', children: [], visible: true, props: { text: '企业版 · 联系我们', subtitle: '✓ 专业版全部功能\n✓ 团队协作\n✓ API 接口\n✓ 专属支持\n✓ 定制开发', titleFontSize: '18px', titleColor: C.sDark, subtitleFontSize: '14px', subtitleColor: C.sGray }, style: { x: 800, y: 920, width: '320px', padding: '32px', backgroundColor: C.white, borderRadius: '12px', boxShadow: '0 1px 3px rgba(0,0,0,0.06)', border: '1px solid #e5e7eb', fontFamily: C.fInter } },

      // 底部 CTA 容器
      {
        id: nid(), type: 'container', visible: true, props: {},
        style: { x: 80, y: 1090, width: '1040px', minHeight: '160px', padding: '40px', backgroundColor: '#312e81', borderRadius: '12px', position: 'relative' },
        children: [
          { id: nid(), type: 'heading', children: [], visible: true, props: { text: '准备好开始了吗？', level: 2 }, style: { x: 280, y: 20, width: '480px', fontSize: '28px', fontWeight: '700', color: C.white, textAlign: 'center', padding: '0', fontFamily: C.fSpace } },
          { id: nid(), type: 'text', children: [], visible: true, props: { text: '免费注册，10 分钟创建你的第一个页面。' }, style: { x: 280, y: 66, width: '480px', fontSize: '16px', color: '#c7d2fe', textAlign: 'center', lineHeight: '1.5', padding: '0', fontFamily: C.fInter } },
          { id: nid(), type: 'button', children: [], visible: true, props: { text: '立即免费开始' }, style: { x: 400, y: 110, fontSize: '16px', fontWeight: '600', color: C.sPrimary, backgroundColor: C.white, padding: '14px 36px', borderRadius: '10px', textAlign: 'center', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontFamily: C.fInter } },
        ],
      },
    ],
    canvas: { backgroundColor: C.sBg, width: '1200px', height: '1300px' },
  },
